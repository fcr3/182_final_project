...
def train(config, agent, train_env, test_env, model_dir, policy, log_kernel_norm_diff, log_kernel_norm, init_all_input_channels):
...
def run():
    ...
    train(configs, ppo_agent, train_venv, valid_venv, log_dir, policy, configs.kernel_norm_diff, configs.kernel_norm, configs.init_all_input_channels)
